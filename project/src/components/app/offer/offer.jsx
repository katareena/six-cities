            ...
            <div className="near-places__list places__list">
              <article className="near-places__card place-card">
                ...
                <div className="place-card__info">
                  ...
                  <h2 className="place-card__name">
                    <Link to="https://ru.reactjs.org">Wood and stone place</Link>
                  </h2>
              ...
              <article className="near-places__card place-card">
                ...
                <div className="place-card__info">
                  ...
                  <h2 className="place-card__name">
                    <Link to="https://ru.reactjs.org">Canal View Prinsengracht</Link>
                  </h2>
              ...
              <article className="near-places__card place-card">
                ...
                <div className="place-card__info">
                  ...
                  <h2 className="place-card__name">
                    <Link to="https://ru.reactjs.org">Nice, cozy, warm big bed apartment</Link>
                  </h2>
                  <p className="place-card__type">Apartment</p>
                </div>
              </article>
